  ...
  [:div.row
   (let [bars (set bars)]
     [:div.col-xs-12
      ...
      (when (:items bars) [items-bar])
      (when (:market bars) [market-bar])])
...
(defn panels
  ...
  (case panel
    ...
    :land-panel [land-panel]
    :land-items-panel [land-items-panel]
    :land-market-panel [land-market-panel]
    :land-valuation-panel [land-valuation-panel]
    [home-panel]))
